...
/**
 * create class FSysMailTemplateExample.java @version 1.0.0 by @author ChenMJ @date 2021-09-16 17:47:00
 */
public class FSysMailTemplateExample {
    ...
    public FSysMailTemplateExample() {
