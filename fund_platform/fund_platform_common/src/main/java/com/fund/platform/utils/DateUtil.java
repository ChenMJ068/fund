package com.fund.platform.utils;
...
/**
 * create class DateUtil.java @version 1.0.0 by @author ChenMJ @date 2021-09-16 16:17:00
 */
public class DateUtil {
    ...
    public static final String FORMAT_TIMESTAMP = "yyyy-MM-dd HH:mm:ss.SS";
    ...
    /**
     * 计算两个日期之间相差分钟数
     * @param smallDateTime smallDateTime
     * @param bigDateTime bigDateTime
     * @return 相差分钟数
     */
